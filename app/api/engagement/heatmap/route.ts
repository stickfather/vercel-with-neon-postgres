...
import { fetchHeatmap } from "src/features/management/engagement/data/engagement.read";
...
export async function GET(request: Request) {
  try {
    ...
    const rows = await fetchHeatmap(filters);
    ...
    return NextResponse.json(
      { error: "Unable to load engagement heatmap." },
