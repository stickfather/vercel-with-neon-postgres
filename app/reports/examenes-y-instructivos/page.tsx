...
export default function ExamenesInstructivosPage() {
  return (
        ...
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-col gap-2">
            ...
            <h1 className="text-3xl font-black text-slate-900 sm:text-[40px]">
              Reporte de Exámenes y Instructivos
            </h1>
            <p className="max-w-2xl text-sm text-slate-600">
              Panel unificado para aprobación de exámenes e instructivos: tasas de aprobación, puntajes, cumplimiento y
              seguimiento de estudiantes con instructivos pendientes.
            </p>
          </div>
        </header>
        <ExamsPanelClient />
