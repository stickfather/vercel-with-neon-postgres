  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col items-center justify-center px-6 py-16 text-center md:px-10">
        <div className="flex w-full flex-col items-center gap-6 rounded-[40px] bg-white/90 px-8 py-12 text-brand-deep shadow-2xl backdrop-blur md:px-12">
          ...
          <Link
            href="/registro"
            className="cta-ripple inline-flex items-center justify-center rounded-full bg-brand-orange px-8 py-3 text-base font-semibold uppercase tracking-wide text-white shadow focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-[#00bfa6]"
          >
            Volver al registro
          </Link>
        </div>
