...
export const metadata: Metadata = {
  title: "Registro de estudiantes · Inglés Rápido Manta",
  description:
    "Selecciona tu nombre, nivel y lección para confirmar la asistencia diaria en el kiosco de Inglés Rápido Manta.",
};
