...
export function StaffAttendanceBoard({ attendances, onShowCelebration }: Props) {
  ...
  const confirmCheckout = async () => {
    ...
    try {
      ...
      onShowCelebration?.({
        ...
        headline:
          friendlyName != null
            ? `¡Gracias, ${friendlyName}!`
            : "¡Salida registrada!",
        body: "Tu salida quedó lista. ¡Nos vemos en la próxima jornada!",
        accent: "sparkles",
      });
